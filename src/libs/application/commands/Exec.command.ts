import { ApplicationExecCommandParam, CommandCompletedEvent } from "@trueffelmafia/electron-types/application";
import { CommandHandlerParam, ElectronEvent } from "@trueffelmafia/electron-types/core";
